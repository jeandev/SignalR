...
namespace Microsoft.AspNet.SignalR.ServiceBus
{
    ...
    public class ServiceBusMessageBus : ScaleoutMessageBus
    {
        ...
        private void TraceSentMessages(IList<Message> messages)
        {
            ...
            {
                _trace.TraceInformation("Message of size {0} bytes sent over Azure Service Bus : {1}", message.Value.Array.Length, message.Encoding.GetString(message.Value.Array));
            }
        }
